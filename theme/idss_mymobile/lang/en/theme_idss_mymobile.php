...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>IDSS MyMobile</h2><img src="mymobile/pix/screenshot.png" /><h2>About</h2><p>IDSS MyMobile, is slightly modified from MyMobile, a mobile theme for Moodle 2.x. More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p></div></div>';
...
$string['no'] = 'No';
$string['pluginname'] = 'IDSS MyMobile';
